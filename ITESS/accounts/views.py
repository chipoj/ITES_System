...
from class_room.models import AskedQuizQuestions
...
def current_user_profile(request):
    ...
    # asked_quiz_questions = AskedQuizQuestions.objects.filter(student=user).all()
...
def update_user_profile(request):
    ...
    return render(request,'accounts/updatprofile.html',context)